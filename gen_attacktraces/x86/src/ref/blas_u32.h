...
static inline void _gf256v_add_u32(uint8_t *accu_b, const uint8_t *a, unsigned _num_byte) {
    ...
    if( !((bp&3) || (ap&3) || (_num_byte<8)) ) {  _gf256v_add_u32_aligned(accu_b,a,_num_byte); return; }
...
static inline void _gf256v_conditional_add_u32(uint8_t *accu_b, uint8_t condition, const uint8_t *a, unsigned _num_byte) {
    ...
    if( !((bp&3) || (ap&3) || (_num_byte<8)) ) {  _gf256v_conditional_add_u32_aligned(accu_b,condition,a,_num_byte); return; }
...
static inline void _gf16v_mul_scalar_u32(uint8_t *a, uint8_t gf16_b, unsigned _num_byte) {
    ...
    uintptr_t ap = (uintptr_t)(const void *)a;
    if( !((ap&3) || (_num_byte<8)) ) {  _gf16v_mul_scalar_u32_aligned(a,gf16_b,_num_byte); return; }
    ...
    while( _num_byte >= 4 ) {
      t.u8[0] = a[0]; t.u8[1] = a[1]; t.u8[2] = a[2]; t.u8[3] = a[3];
      t.u32 = gf16v_mul_u32(t.u32, gf16_b);
      a[0] = t.u8[0]; a[1] = t.u8[1]; a[2] = t.u8[2]; a[3] = t.u8[3];
      a += 4;
      _num_byte -= 4;
    }
    if( 0==_num_byte ) return;
...
static inline void _gf256v_mul_scalar_u32(uint8_t *a, uint8_t b, unsigned _num_byte) {
    ...
    uintptr_t ap = (uintptr_t)(const void *)a;
    if( !((ap&3) || (_num_byte<8)) ) {  _gf256v_mul_scalar_u32_aligned(a,b,_num_byte); return; }
...
static inline void _gf16v_madd_u32(uint8_t *accu_c, const uint8_t *a, uint8_t gf16_b, unsigned _num_byte) {
    ...
    if( !((cp&3) || (ap&3) || (_num_byte<8)) ) {  _gf16v_madd_u32_aligned(accu_c,a,gf16_b,_num_byte); return; }
    ...
    while( _num_byte >= 4 ) {
      t.u8[0] = a[0]; t.u8[1] = a[1]; t.u8[2] = a[2]; t.u8[3] = a[3];
      t.u32 = gf16v_mul_u32(t.u32, gf16_b);
      accu_c[0] ^= t.u8[0]; accu_c[1] ^= t.u8[1]; accu_c[2] ^= t.u8[2]; accu_c[3] ^= t.u8[3];
      a += 4;
      accu_c += 4;
      _num_byte -= 4;
    }
...
static inline void _gf256v_madd_u32(uint8_t *accu_c, const uint8_t *a, uint8_t gf256_b, unsigned _num_byte) {
    ...
    uintptr_t ap = (uintptr_t)(const void *)a;
    uintptr_t cp = (uintptr_t)(const void *)accu_c;
    if( !((cp&3) || (ap&3) || (_num_byte<8)) ) {  _gf256v_madd_u32_aligned(accu_c,a,gf256_b,_num_byte); return; }
