/// @file uov_blas.h
/// @brief Defining the functions used in rainbow.c acconding to the definitions in uov_config.h
///
///  Defining the functions used in rainbow.c acconding to the definitions in uov_config.h
